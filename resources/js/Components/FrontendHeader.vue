...
<template>
    <div class="w-full container mb-8">
        <header class="max-w-screen-xl mx-auto px-4 pb-5">
            <!-- nav logo -->
            <!-- <ApplicationLogo /> -->
            ...
            <nav class="bg-white border-gray-200 dark:bg-gray-900">
                <div class="flex flex-wrap items-center justify-between">
                    ...
                    >
                        <ul
                            v-if="props.canLogin"
                            class="font-medium flex flex-col sm:items-center p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700"
                        >
                            ...
                            <li>
                                <Link
                                    :href="route('home')"
                                    :class="{
                                        'bg-indigo-700 text-white md:bg-transparent md:text-indigo-700':
                                            $page.component === 'Frontend/Home',
                                    }"
                                    class="block py-2 px-3 rounded md:bg-transparent md:text-gray-900 md:hover:text-indigo-700 md:p-0 dark:text-white md:dark:text-indigo-500"
                                    aria-current="page"
                                >
                                    Home
                                    <font-awesome-icon
                                        :class="{
                                            'stroke-white sm:stroke-indigo-500':
                                                $page.component ===
                                                'Frontend/Home',
                                        }"
                                        class="text-transparent stroke-[2rem] stroke-indigo-500 pl-1"
                                        icon="fas fa-home"
                                    />
                                </Link>
                            </li>
                            ...
                            <li>
                                ...
                                >
                                    ...
                                    <font-awesome-icon
                                        :class="{
                                            'stroke-white md:text-indigo-700':
                                                $page.component ===
                                                'Frontend/ShoppingCart',
                                        }"
                                        class="text-transparent hover:text-indigo-500 stroke-[2rem] pl-1 stroke-indigo-500"
                                        icon="fas fa-cart-shopping"
                                    />
                                </Link>
                            </li>

                            <!-- shopping favorite icon -->
                            <li>
                                <Link
                                    :class="{
                                        'bg-indigo-700 text-white md:bg-transparent md:text-indigo-700':
                                ...
                                >
                                    <font-awesome-icon
                                        class="border-2 my-4 sm:my-0 rounded-full border-indigo-200 hover:border-indigo-500 focus:ring-2 focus:ring-indigo-500 text-transparent hover:text-indigo-500 rounded-full border stroke-[2rem] p-2 stroke-indigo-500"
                                        icon="fas fa-heart"
                                    />
                                </Link>
                            </li>
                                    ...
                                    <template #trigger>
                                        <span class="inline-flex rounded-md">
                                            ...
                                            >
                                                <font-awesome-icon
                                                    icon="fas fa-user"
                                                    class="text-transparent stroke-[4rem] stroke-indigo-500"
                                                />
                                            </button>
                                        </span>
                                    </template>
