    ...
    <GuestLayout>
        ...
        <div class="container">
            <div class="shopping-card-items max-w-screen-xl mx-auto px-4 py-8">
                <div class="">
                    <h3 class="text-2xl uppercase font-bold text-gray-500">cart</h3>
                    <!-- card items -->
                    <!-- shopping cart -->
                        ...
                        <section class=" antialiased dark:bg-gray-900">
                            <div class="mx-auto max-w-screen-xl 2xl:px-0">
                                ...
                                <div class="mx-auto w-full flex-none lg:max-w-2xl xl:max-w-4xl">
                                    <div class="space-y-6">
                                        <div class="rounded-lg border-2 border-indigo-400 bg-white p-4 shadow-md shadow-indigo-50 dark:border-gray-700 dark:bg-gray-800 md:p-6">
